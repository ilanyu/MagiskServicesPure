...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;Ljava/io/File;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/AppWarnings;->mPackageName:Ljava/lang/String;
...
.method private showUnsupportedCompileSdkDialogUiThread(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/am/UnsupportedCompileSdkDialog;->isShowing()Z

    move-result v0

    if-eqz v0, :cond_1b

    iget-object v0, p0, Lcom/android/server/am/AppWarnings;->mPackageName:Ljava/lang/String;
...
.method private writeConfigToFileAmsThread()V
    ...
    monitor-exit v0
    :try_end_b
    .catchall {:try_start_3 .. :try_end_b} :catchall_97
    ...
    :try_end_86
    .catch Ljava/io/IOException; {:try_start_d .. :try_end_86} :catch_87
