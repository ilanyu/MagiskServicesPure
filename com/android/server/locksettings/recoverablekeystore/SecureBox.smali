...
.method static varargs concat([[B)[B
    ...
    .end local v3    # "outputPos":I
    .local v5, "outputPos":I
    :goto_1c
    if-ge v3, v4, :cond_29
...
.method private static hkdfDeriveKey([B[B[B)Ljavax/crypto/SecretKey;
    ...
    .line 314
    .end local v2    # "hkdfOutput":[B
    :catch_37
    move-exception v2

    .line 316
    .local v2, "ex":Ljava/security/InvalidKeyException;
    new-instance v3, Ljava/lang/RuntimeException;
    ...
    .line 306
    .end local v1    # "pseudorandomKey":[B
    .end local v2    # "ex":Ljava/security/InvalidKeyException;
    :catch_3e
    move-exception v1
...
.method private static validateEcPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    .line 438
    .local v1, "rhs":Ljava/math/BigInteger;
    ...
    .end local v1    # "rhs":Ljava/math/BigInteger;
    :cond_58
